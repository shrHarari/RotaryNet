...
class TextPainterVsParagraph extends StatefulWidget {
  TextPainterVsParagraph({Key key}) : super(key: key);

  @override
  _TextPainterVsParagraphState createState() => _TextPainterVsParagraphState();
}

class _TextPainterVsParagraphState extends State<TextPainterVsParagraph> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   children: <Widget>[
      //     ConstrainedBox(
      //       constraints: const BoxConstraints.expand(height: 200, width: 100),
      //       child: CustomPaint(
    ...
    for (int i = 0; i < 100; i++) {
      if (useTextPainter) {
        final TextPainter textPainter = TextPainter(
            ...
            maxLines: 2, // In both TextPainter and Paragraph there is no option to define max height, but there is `maxLines`
        ...
        print('+++TextPainter: ${textPainter.text}');
      }
      else {
        ...
        print('+++paragraphBuilder: ${paragraph.computeLineMetrics().toString()}');
      }
    }
